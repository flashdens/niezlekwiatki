...
<html lang="en">
  <head>
    ...
    <title>Wyszukaj | NiezłeKwiatki.pl</title>
  ...
  <div class="p-3 justify-content-center ">
        <table class="table-bordered table-responsive justify-content-center mx-auto text-center border col-8 ">
            ...
            <?php
            $search = "%".$_GET['search']."%";
            $query = "SELECT * FROM niezlekwiatki_topics WHERE topic_title LIKE ?";
            ...
            if (!mysqli_num_rows($out)) {
                echo '<h2 class="text-center"> Nie znaleziono żadnych tematów pasujących do wzorca. </h2>';
                exit();
            } else {
                echo '<h1 class="text-center p-3"> Wyniki wyszukiwania:</h1>';
